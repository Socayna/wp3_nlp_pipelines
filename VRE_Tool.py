...
class myTool(Tool):
    ...
    def generate_parameter_file(self, input_files, arguments, parameters_file_path):
        ...
        params = {
            "projectname": "Example",
            "datadirectory": None,
            "metabolite_data_file": "metabolon_v1_example.xlsx",
    ...
    def Rinit(self, input_files, output_metadata, parameters_file_path):
        """
        ...
        :param output_metadata: List of output files metadata expected to be generated.
        :type output_metadata: list
        :param parameters_file_path: Full path to the parameter file generated by `generate_parameter_file`.
        :type parameters_file_path: str
        """
        rc = None
        ...
        try:
            ...
            # Call metaboprep pipeline using the generated parameter file
            cmd = [
            ...
            if rc != 0:
                logger.error('Metaboprep pipeline failed')
                raise Exception('Metaboprep pipeline failed')

            if not os.path.isfile(output_file_path):
                logger.error('Output file not created')
                raise Exception('Output file not created')

            print("\n-- Metaboprep pipeline completed successfully")
